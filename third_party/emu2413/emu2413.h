...
/**
 * Advance one internal YM2413 envelope tick for melodic channel 0 only.
 * This project-local helper uses the same EG/LFO implementation as OPLL_calc
 * without calculating phase, waveform, noise, mixing, or rate conversion.
 */
void OPLL_advanceEnvelope(OPLL *opll);
